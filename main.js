...
const BLOCK_DATA = [
    {svg: './svg/website.svg', title: 'WEBSITE DESIGN', id: 1, text: 'Our creative designers will craft a unique and visually appealing look for your web project that will leave a lasting impression on your customers.'},
    {svg: './svg/logocreate.svg', title: 'LOGO DESIGN AND BRANDING', id: 2, text: 'We will create a distinctive logo for your brand and develop a brand book to help you maintain a consistent style and identity.'},
    {svg: './svg/development.svg', title: 'WEBSITE DEVELOPMENT AND CODING', id: 3, text: 'Our programmers will create a functional and responsive website tailored to your needs and goals.'},
    {svg: './svg/mobile.svg', title: 'MOBILE APP DEVELOPMENT', id: 4, text: 'We specialize in developing mobile applications that make your business more accessible to smartphone users.'},
    {svg: './svg/bot.svg', title: 'Telegram Bot Development', id: 5, text: 'Our experts will create chatbots that enhance your communication with customers through Telegram.'},
    {svg: './svg/menejment.svg', title: 'TURNKEY PROJECT DEVELOPMENT', id: 6, text: 'We offer end-to-end project development services, starting from ideation and ending with promotion, allowing you to focus on essential aspects of your business. '},
    {svg: './svg/marketing.svg', title: 'WEBSITE PROMOTION AND MARKETING', id: 7, text: 'Our team of marketers will help you promote your business online, attract an audience, and achieve a leading position in the market.'},
    {svg: './svg/made.svg', title: 'MADE BY ORDER', id: 8, text: 'We work with various business sectors and are ready to help you achieve online success. If you have any specific requirements or ideas for our services, please don’t hesitate to contact us.'},
];
...
const growData = [
    {title: 'Backend Developer', slogan: 'Requirements:', text: `
         
        Experience in development, knowledge of programming languages.
    `},

    {title: 'Frontend Internship', slogan: 'Requirements:', text: `
        
        Willingness to learn and grow in web development.
    `},

    {title: 'Client Acquisition Manager', slogan: 'Requirements:', text: `
